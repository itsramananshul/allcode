...
Alternatively, download `allcode-0.3.2.tgz` from the [v0.3.2 release](https://github.com/itsramananshul/allcode/releases/tag/v0.3.2) and install that package with `npm install -g ./allcode-0.3.2.tgz`.
